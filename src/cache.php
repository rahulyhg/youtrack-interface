...
class cache
{
     ...
     */
    public function getFilename($ref)
    {
     ...
     */
    public function validateFileName($ref)
    {
        $delimiter = '¦';
        $unwanted = array('/');
     ...
     * @return bool
     */
    public function checkForCached($ref)
    {
     ...
     * @return bool
     */
    public function createCache($ref, $content)
    {
        $fileName = $this->getFilename($ref);
