...
* fill in the details in customSettings.php, its important change the cookie encryption key for security reasons. We use a subdomain that we own for our youtrack and this was causing me issues. I had to use the one youtrack provided  https://******.myjetbrains.com/youtrack for our youtrackUrl.
